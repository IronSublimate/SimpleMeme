...
import com.ironsublimate.mememanager.adapter.ExpShopRecyclerViewAdapter;
...
import com.ironsublimate.mememanager.http.WebImageInterface;
...
public class ShopActivity extends AppCompatActivity {
    ...
    private void requestData(final int page){
        currentPage = page;
        if (currentPage > 1 && (currentPage-1) * 4 > totalCount){
            ...
            call = request.getDirList(currentPage,4);
